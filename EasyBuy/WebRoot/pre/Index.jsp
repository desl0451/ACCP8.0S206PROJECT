...
<%@ page import="cn.easybuy.utils.Pager" %>
<%@ page import="cn.easybuy.param.NewsParams" %>
...
<link rel="icon" href="${ctx}/statics/images/index/taologo.png" type="image/x-icon" />
<link type="text/css" rel="stylesheet" href="${ctx}/statics/css/style.css" />
<link type="text/css" rel="stylesheet" href="${ctx}/statics/css/index.css" />
<link type="text/css" rel="stylesheet" href="${ctx}/statics/css/ShopShow.css" />
<link type="text/css" rel="stylesheet" href="${ctx}/statics/css/MagicZoom.css" />
...
<body>
	...
	<!-- Begin Body -->
	<div class="top">
   		 <div class="logo"><a href="Index.html"><img src="${ctx}/statics/images/logo.png" /></a>
   	</div>
    <div class="search">
	    	<form>
		...
		<div class="i_ban_bg">
	        ...
	        <div class="inews">
	            ...
	            <%
					...
					try {
						List<News> ulist = dao.queryNewsList(null);
						for (News news : ulist) {
	            ...
	            <c:forEach items="${news}" var="temp">
                    <li><span>[ 公告 ]</span>
                        <a href="${ctx}/admin/news?action=newsDeatil&id=">${temp.title }</a>
                    </li>
                </c:forEach>
	...
	<div class="top">
	    <div class="logo"><a href="${ctx}/Home?action=index"><img src="${ctx}/statics/${ctx}/statics/images/logo.png"></a></div>
	    <div class="search">
	        <form>
