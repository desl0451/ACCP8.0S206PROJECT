...
<title>淘宝 - 淘！我喜欢</title>
 ...
 <!--[if IE 6]>
	...
	<script type="text/javascript" src="${ctx}/statics/js/n_nav.js"></script>    
    <script type="text/javascript" src="${ctx}/statics/js/milk_ban.js"></script>
    <script type="text/javascript" src="${ctx}/statics/js/paper_ban.js"></script>
    <script type="text/javascript" src="${ctx}/statics/js/baby_ban.js"></script>
